...
#ifndef WNDCOMMONS_INCLUDED
#define WNDCOMMONS_INCLUDED


#include "WndCommons\WndCommonsApi.h"


namespace abscodes {
namespace wndcommons {} // namespace wndcommons
} // namespace abscodes


#endif // WNDCOMMONS_INCLUDED
